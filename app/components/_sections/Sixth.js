      ...
      <div className="bg-white py-12 w-full">
        <div className="mx-auto px-6 md:px-12 lg:px-20 w-full items-center justify-center">
          ...
          <div className="text-center mb-10 flex flex-col items-center justify-center">
            <div className="flex items-center justify-center gap-3 bg-green-100 font-allround-medium border-blue-300 border-2 text-blue-600 text-xs md:text-sm px-4 py-2 rounded-full uppercase font-medium">
              <Image
                src="/svg/globe.svg"
                alt="globe"
                height={500}
