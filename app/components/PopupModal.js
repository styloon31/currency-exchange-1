    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white border-2 border-lightOrange rounded-lg shadow-lg w-full max-w-md p-6 relative">
            {/* Close Button */}
            <button
              onClick={togglePopup}
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full border rounded-md p-2 focus:ring-lightOrange focus:border-lightOrange"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#FC8E06] to-[#FEBC3E] text-white py-2 px-4 rounded-md transition"
              >
                Request a Call Back
              </button>
            </form>
