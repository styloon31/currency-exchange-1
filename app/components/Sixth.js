      ...
      <div className="bg-white py-12 w-full">
        <div className="mx-auto px-6 md:px-12 lg:px-20 w-full items-center justify-center">
          ...
          <div className="text-center mb-10 flex flex-col items-center justify-center">
            <div className="flex items-center justify-center gap-3 bg-green-100 font-allround-medium border-green-300 border-2 text-green-600 text-xs md:text-sm px-4 py-2 rounded-full uppercase font-medium">
              <Image
                src="/svg/globe.svg"
                alt="globe"
                height={500}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Card 1 */}
            <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-lg text-center border-green-300 border-2">
